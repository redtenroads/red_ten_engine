...
SoundController *ComponentSoundPlayer::soundController;
...
void ComponentSoundPlayer::setSoundController(SoundController *soundController)
{
    ComponentSoundPlayer::soundController = soundController;
}