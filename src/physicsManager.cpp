...
void PhysicsManager::setupPhysics()
{
...
PhysicsDescriptor *PhysicsManager::createSystem(Vector3 gravity, int sizeOfAllocator)
{
...
int PhysicsManager::getMovingLayerId()
{
    return Layers::MOVING;
}

int PhysicsManager::getStaticLayerId()
{
    return Layers::NON_MOVING;
}

int PhysicsManager::getRootLayerId()
{
    return Layers::ROOT;
}

void *PhysicsManager::getWorld()
{
    return world;
}