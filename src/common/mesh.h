...
public:
    ...
    EXPORT void setupFloatsArray(const float *data, int vertexAmount, int attributesAmount, int *attributeSize);
...
protected:
    ...
    unsigned int makeVAO(int attributesAmount, int *attributeSize);
