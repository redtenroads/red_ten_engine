...
ShadersController *Effect::shadersController = nullptr;
...
void Effect::makeFromShaderSource(const char *fragmentShader)
{
    ...
    programm = shadersController->makeProgramm(vertexShader, fragmentShader);
}
...
void Effect::setShadersController(ShadersController *shadersController)
{
    Effect::shadersController = shadersController;
}