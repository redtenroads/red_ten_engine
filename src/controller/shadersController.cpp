...
void ShadersController::compileSysShaders()
{
...
void ShadersController::switchShader(ShaderDescriptor *shader)
{
...
void ShadersController::log(unsigned int shader)
{
    GLchar log[1024];
...
ShaderDescriptor *ShadersController::getSpriteShader()
{
    return &spriteShader;
}
ShaderDescriptor *ShadersController::getSpriteFramedShader()
{
    return &spriteFramedShader;
}
ShaderDescriptor *ShadersController::getScreenShader()
{
    return &screenShader;
}

ShaderDescriptor *ShadersController::getEffectShader()
{
    return &effectShader;
}

ShaderDescriptor *ShadersController::getClearShader()
{
    return &clearShader;
}

unsigned int ShadersController::makeVBO(float *points, int amount)
{
    unsigned int vbo = 0;
    glGenBuffers(1, &vbo);
...
unsigned int ShadersController::makeVAO(unsigned int vbo)
{
    unsigned int vao = 0;
...
unsigned int ShadersController::makeProgramm(const char *vertexShader, const char *fragmentShader)
{
    int isCompiled;
...
void ShadersController::compileSpriteShader()
{
...
void ShadersController::compileSpriteFramedShader()
{
    unsigned int vbo = makeVBO(spritePoints, 20);
    unsigned int vao = makeVAO(vbo);
...
void ShadersController::compileScreenShader()
{
...
void ShadersController::compileEffectShader()
{
    unsigned int vbo = makeVBO(screenPoints, 20);
    unsigned int vao = makeVAO(vbo);
...
void ShadersController::compileClearShader()
{
    unsigned int vbo = makeVBO(screenPoints, 20);
    unsigned int vao = makeVAO(vbo);
